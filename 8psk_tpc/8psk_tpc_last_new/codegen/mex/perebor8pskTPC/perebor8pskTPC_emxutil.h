/*
 * perebor8pskTPC_emxutil.h
 *
 * Code generation for function 'perebor8pskTPC_emxutil'
 *
 */

#ifndef __PEREBOR8PSKTPC_EMXUTIL_H__
#define __PEREBOR8PSKTPC_EMXUTIL_H__
...
/* End of code generation (perebor8pskTPC_emxutil.h) */
