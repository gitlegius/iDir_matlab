...
static emlrtRSInfo pc_emlrtRSI = { 46, "sumprod",
...
static emlrtRSInfo rc_emlrtRSI = { 19, "sumprod",
  "C:\\Program Files\\MATLAB\\R2014b\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m"
};
...
real_T sum(const emlrtStack *sp, const real_T x_data[], const int32_T x_size[2])
{
  ...
  boolean_T cond;
  const mxArray *b_y;
  static const int32_T iv28[2] = { 1, 37 };

  const mxArray *m8;
  char_T cv26[37];
  int32_T i;
  static const char_T cv27[37] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
  ...
  if (cond) {
    ...
    emlrtInitCharArrayR2013a(&b_st, 37, m8, cv26);
    emlrtAssign(&b_y, m8);
